VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} modifpret 
   Caption         =   "Modifier un prêt"
   ClientHeight    =   9855
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   14970
   OleObjectBlob   =   "modifpret.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "modifpret"
...
tablo3 = .Range("B2:B" & derligne)
textbox3.List = tablo3
End With
