VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} retourpretobjet 
   Caption         =   "Retour d'un prêt"
   ClientHeight    =   12225
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   14955
   OleObjectBlob   =   "retourpretobjet.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "retourpretobjet"
...
TextBox10.Value = Now
TextBox12.Value = TextBox6
TextBox13.Value = pret.ComboBox7
End Sub

Private Sub CommandButton5_Click()
TextBox13.Value = "POLVECHE_THEO"
End Sub

Private Sub CommandButton6_Click()
TextBox13.Value.Value = "DURIEUX_NOE"
End Sub

Private Sub CommandButton7_Click()
TextBox13.Value = "PARROD_STEPHANE"
End Sub

Private Sub CommandButton8_Click()
TextBox13.Value = "JUGI_DAVID"
End Sub

Private Sub CommandButton4_Click()
TextBox13.Value = "DELOOZE_MICHAEL"
End Sub

Private Sub CommandButton10_Click()
  Unload retourpretobjet
  Unload pret
  accueil.CommandButton5 = True
End Sub
...
Set olApp = CreateObject("Outlook.application")
        ...
        With Mail
            .display
            .To = TextBox15
            .Subject = "RETOUR PRET_n°" & Enreg & " _ " & textbox3
            .HTMLBody = "Un prêt a été crée par " & TextBox9 & " le " & textbox4 & "<br>" & _
                        ...
                        "La quantité retourné est de : " & TextBox6 & "<br>" & _
...
'ActiveWorkbook.Names.Add Name:=NomTableau4, RefersTo:=Rng                                     ' A adapter
 ...
 colVisu4 = Array(4, 5, 6)       ' Colonnes ListBox (à adapter)
 colInterro = Array(4, 5, 6)    ' colonnes à interroger (adapter)
 '----
...
Me.ListBox10.ColumnCount = NbCol4
 Me.ListBox10.ColumnWidths = "0;150;0;0"
...
If TextBox10 = "" Then MsgBox "Date&heure non renseignée": TextBox10.SetFocus: Exit Sub
If TextBox12 = "" Then MsgBox "Quantité non renseignée": TextBox12.SetFocus: Exit Sub
If TextBox14 = "En cours" Then MsgBox "Prêt toujours en cours": TextBox12.SetFocus: Exit Sub
  Enreg = Me.Enreg10
  For c = 1 To NbCol4
...
Set olApp = CreateObject("Outlook.application")
        ...
        With Mail
            ...
            .To = TextBox15
            .Subject = "RETOUR PRET_n°" & Enreg & " _ " & textbox3
            .HTMLBody = "Le retour de prêt n°" & Enreg & " a été crée par " & TextBox9 & " le " & textbox4 & "<br>" & _
                        "<br>" & _
                        "L'objet emprunté était: " & TextBox5 & "<br>" & _
                        "La quantité retournée est de : " & TextBox12 & " par rapport à la quantité prise de " & TextBox6 & "<br>" & _
                        "<br>" & _
                        "Pour toute demande, veuillez contacter la regie à l'adresse suivante  : " & "gestionstockregie@esad-orleans.fr" & "<br>" & _
                        .HTMLBody
            .display
