VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Form6Combos 
   Caption         =   "essai"
   ClientHeight    =   12405
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   21705
   OleObjectBlob   =   "Form6Combos.frx":0000
   ShowModal       =   0   'False
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "Form6Combos"
...
'ActiveWorkbook.Names.Add Name:=NomTableau4, RefersTo:=Rng                                     ' A adapter
 ...
 ColCombo4 = Array(14, 7)                                   ' A adapter (1 à 6 colonnes maxi)
 colVisu4 = Array(3, 4, 5, 6, 8, 9)      ' Colonnes ListBox (à adapter)
 colInterro = Array(3, 4, 5, 6, 8, 9)   ' colonnes à interroger (adapter)
 '----
