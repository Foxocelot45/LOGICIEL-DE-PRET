...
Private Sub CreateInterface()
    ...
    tabControl.Pages(2).Caption = "Articles en Prêt"
...
Private Sub CreateTab0_Articles()
    ...
    With lblDetails
        ...
        .Width = 676
        .Height = 80
        .Caption = "Sélectionnez un article"
        .Font.Size = 9
    End With
End Sub
...
Private Sub CreateTab1_Emprunteurs()
    ...
    With lblDetails
        ...
        .Width = 676
        .Height = 80
        .Caption = "Sélectionnez un emprunteur"
        .Font.Size = 9
    End With
End Sub
...
Private Sub CreateTab2_ArticlesEnPret()
    ...
    With lblTitle
        .Caption = "Articles Actuellement en Prêt"
        .Left = 12
        .Top = 12
        .Width = 700
        .Height = 25
    ...
    With lblStats
        ...
        .Height = 24
        .Font.Size = 9
        .Caption = "Total prêts en cours: 0"
    End With
End Sub
...
Private Sub LoadArticlesEnPretData()
    ...
    For i = 2 To wsPrets.Cells(wsPrets.Rows.count, 1).End(xlUp).Row
        If wsPrets.Cells(i, 15).value = "" Then
            lstPrets.AddItem
            lstPrets.List(lstPrets.ListCount - 1, 0) = wsPrets.Cells(i, 3).value
            lstPrets.List(lstPrets.ListCount - 1, 1) = wsPrets.Cells(i, 6).value
            lstPrets.List(lstPrets.ListCount - 1, 2) = wsPrets.Cells(i, 7).value
            lstPrets.List(lstPrets.ListCount - 1, 3) = wsPrets.Cells(i, 4).value
            count = count + 1
        End If
    Next i
    ...
    lblStats.Caption = "Total prêts en cours: " & count
End Sub
...
Private Sub btnNewArticle_Click()
    MsgBox "Formulaire création article en développement", vbInformation
End Sub

Private Sub btnEditArticle_Click()
    MsgBox "Formulaire modification article en développement", vbInformation
End Sub

Private Sub btnDeleteArticle_Click()
    MsgBox "Suppression article en développement", vbInformation
End Sub

Private Sub btnNewEmp_Click()
    MsgBox "Formulaire création emprunteur en développement", vbInformation
End Sub

Private Sub btnEditEmp_Click()
    MsgBox "Formulaire modification emprunteur en développement", vbInformation
End Sub

Private Sub btnDeleteEmp_Click()
    MsgBox "Suppression emprunteur en développement", vbInformation
End Sub
